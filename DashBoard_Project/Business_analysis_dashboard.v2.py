...
def encode_and_predict(feat_dict):
    ...
    """
    if not MODEL_LOADED:
        raise ValueError("model.pkl not found – place it in the same folder as this script")
    row = {}
...
/* ── Dropdown menu open: option text ── */
.Select-menu-outer {
...
/* ── Dash 2.x uses different class names ── */
